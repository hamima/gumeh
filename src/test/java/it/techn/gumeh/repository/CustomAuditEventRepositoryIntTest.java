...
import it.techn.gumeh.config.audit.AuditEventConverter;
import it.techn.gumeh.domain.PersistentAuditEvent;
...
import static it.techn.gumeh.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
