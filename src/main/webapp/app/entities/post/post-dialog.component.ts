...
import { Resurce, ResurceService } from '../resurce';
...
export class PostDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.resurceService.query()
            .subscribe((res: HttpResponse<Resurce[]>) => { this.resurces = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackResurceById(index: number, item: Resurce) {
        return item.id;
    }
}
